...
| [site-intelligence](./skills/site-intelligence/SKILL.md) | 308 | 17.0 KB | Queries, audits, and analyzes the 37 marketing pages via the pages-marketing.json snapshot. |
